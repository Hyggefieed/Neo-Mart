    ...
    <div className="min-h-screen bg-white">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <button
              className="px-8 py-4 text-lg font-semibold text-white rounded-lg hover:opacity-90 transition-opacity flex items-center mx-auto"
              style={{ backgroundColor: "#A6D3A0" }}
            >
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl" style={{ color: "#808782" }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                rating: 4.7,
                image:
                  "https://images.pexels.com/photos/3618162/pexels-photo-3618162.jpeg?auto=compress&cs=tinysrgb&w=400",
              },
            ].map((product, index) => (
              <div
                key={index}
                className="bg-white rounded-lg shadow-sm border hover:shadow-md transition-shadow"
                style={{ borderColor: "#808782" }}
              >
                <img
                  src={product.image}
                  alt={product.name}
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center mb-3">
                    <Star
                      ...
                      style={{ color: "#A6D3A0" }}
                    />
                    <span className="ml-1 text-sm" style={{ color: "#808782" }}>
                      {product.rating}
                    </span>
                  </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              >
                ...
                <p className="text-sm" style={{ color: "#808782" }}>
                  {category.count}
                </p>
              </div>
            ))}
      ...
      <section className="py-20" style={{ backgroundColor: "#B3FFB3" }}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8" style={{ color: "#808782" }}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
            ...
            <button
              className="px-6 py-3 bg-white text-black rounded-lg hover:opacity-90 transition-opacity flex items-center justify-center"
              style={{ color: "#656565" }}
            >
